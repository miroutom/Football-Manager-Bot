...
async def setup_bot_commands(bot: Bot) -> None:
    await bot.set_my_commands(
        [
            ...
            BotCommand(command="transfer", description="Загрузить трансферы и составы из приложения"),
            ...
            BotCommand(command="wc", description="ЧМ: жеребьёвка, группы, вызовы, месяц 11"),
            ...
            BotCommand(command="ovr_debug", description="DEBUG: OVR — лига→клуб→игрок (без записи)"),
        ],
    )
