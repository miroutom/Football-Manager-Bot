...
async def _send_injury_root(message: Message, state: FSMContext) -> None:
    ...
    await message.answer(
        ...
        "Только <b>2</b> или <b>4</b> месяца. «Жизни» подряд: полевые — <b>2</b> "
        "(1-й удар без пропуска, 2-й — травма и уход), вратари — <b>5</b> "
        "(1–4 без пропуска, 5-й — травма и уход).\n\n"
...
async def cb_injury_root_enter(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    await callback.message.answer(
        ...
        "Только 2 или 4 месяца. Полевые: 1-й удар — жизнь 1/2 (играет), 2-й подряд — травма и уход.\n"
        "Вратари: 1–4 удар — жизни без пропуска, 5-й — травма и уход.\n"
        "Рейтинг не меняется.\n\n"
