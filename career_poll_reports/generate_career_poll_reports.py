...
DOSSIERS = [
    {
        ...
        "competition_lines": [
            "На ПФА сейчас Энрике: 14+10 за сезон (ЛЧ / РПЛ / кубок). Место в основе придётся отбирать.",
        ],
        "vs": (
            YOU_VS,
            {
                ...
                "ga": 24,
                "tours": [
                    {"comp": "ЛЧ", "stat": "2+1", "apps": "8 игр"},
                    {"comp": "РПЛ", "stat": "9+6", "apps": "28 игр"},
                    {"comp": "Кубок", "stat": "3+3", "apps": "6 игр"},
                ],
            },
        ),
        "pros": [
    ...
    },
    {
        ...
        "competition_lines": [
            "На фланге Ярослав Гладышев (77): 6+2 за 25 игр. Ты выше рейтингом и сильно выше по отдаче.",
        ],
        "vs": (
            YOU_VS,
            {
                ...
                "ga": 8,
                "tours": [
                    {"comp": "ЛЧ", "stat": "1+0", "apps": "6 игр"},
                    {"comp": "РПЛ", "stat": "3+1", "apps": "15 игр"},
                    {"comp": "Кубок", "stat": "2+1", "apps": "4 игры"},
                ],
            },
        ),
        "pros": [
    ...
    },
    {
        ...
        "competition_lines": [
            "Солари (80): 0+2 за 24. Бонгонда (74) живее — 3+7 за 21, но рейтингом слабее.",
        ],
        "vs": (
            YOU_VS,
            {
                ...
                "ga": 2,
                "tours": [
                    {"comp": "РПЛ", "stat": "0+2", "apps": "20 игр"},
                    {"comp": "Кубок", "stat": "0+0", "apps": "4 игры"},
                ],
            },
        ),
        "pros": [
    ...
    },
    {
        ...
        "competition_lines": [
            "Мантуан (79) рядом по OVR, но 8+2 за 46 — это не твой уровень. Глубина фланга ещё слабее.",
        ],
        "vs": (
            YOU_VS,
            {
                ...
                "ga": 10,
                "tours": [
                    {"comp": "ЛЕ", "stat": "2+1", "apps": "14 игр"},
                    {"comp": "РПЛ", "stat": "3+1", "apps": "26 игр"},
                    {"comp": "Кубок", "stat": "3+0", "apps": "6 игр"},
                ],
            },
        ),
        "pros": [
